...
class Cible:
    ...
    def install_nmap(self):
        """Installe nmap automatiquement si nécessaire (Debian/Ubuntu uniquement)"""
        try:
            # Vérifie si nmap est déjà présent sinon installation 
            if subprocess.call(['which', 'nmap'], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL) == 0:
                return True
